...
// @updateUrl    https://raw.gitmirror.com/baiyu-yu/plug-in/main/%E9%AA%B0%E5%A8%98%E5%AF%BB%E8%AE%BF%E4%BA%91%E7%AB%AF%E7%89%88v1.0.6.js
...
async function fetchQQName(qqNumber) {
    try {
        ...
        // 如果第二个 API 失败，尝试第三个 API
        const thirdUrl = `https://api.yyx.la/api/get.info.qq?qq=${qqNumber}`;
        ...
        // 如果第三个 API 失败，尝试第四个 API
        const fourthUrl = `https://api.qjqq.cn/api/qqinfo?qq=${qqNumber}`;
        ...
        const fifthUrl = `http://110.41.69.149:8086/get_stranger_info?user_id=${qqNumber}&no_cache=false`;
